...
#endif // KONAN_OBJC_INTEROP
    RETURN_RESULT_OF(mm::createWeakReferenceCounter, referred);
}
...
RUNTIME_NOTHROW extern "C" OBJ_GETTER(Konan_WeakReferenceCounter_get, ObjHeader* counter) {
    RETURN_RESULT_OF(mm::derefWeakReferenceCounter, counter);
}

RUNTIME_NOTHROW extern "C" void DisposeWeakReferenceCounter(ObjHeader* counter) {
    mm::disposeWeakReferenceCounter(counter);
}
