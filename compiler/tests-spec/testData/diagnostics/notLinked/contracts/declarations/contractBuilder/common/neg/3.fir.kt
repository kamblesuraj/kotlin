...
fun case_4(value_1: Nothing?, value_2: Boolean?): Boolean? {
    contract { <!ERROR_IN_CONTRACT_DESCRIPTION!>returns(null) implies (value_1 == null || value_2 != null || <!SENSELESS_COMPARISON!>value_2 == false<!>)<!> }
    return if (value_1 == null || value_2 != null || <!SENSELESS_COMPARISON!>value_2 == false<!>) null else true
}
