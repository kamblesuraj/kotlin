...
fun case_10(x: Any?, z: Any, b: Boolean?) {
    ...
    z === y || if (b == true) return else if (<!FORBIDDEN_IDENTITY_EQUALS_WARNING!>b === false<!>) null!! else throw Exception()
    <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & kotlin.Any")!>x<!>
    <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any")!>y<!>
    <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any")!>y<!>.equals(10)
}
...
fun case_12(x: Any?, z: Any, b: Boolean?) {
    while (true) {
        ...
        select(z) !== y && if (b == true) return else if (<!FORBIDDEN_IDENTITY_EQUALS_WARNING!>b === false<!>) null!!else throw Exception()
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any?")!>x<!>
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any")!>y<!>
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any")!>y<!>.equals(10)
    }
