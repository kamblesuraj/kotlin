...
fun case_10() {
    ...
    if (a.prop_4 === null || <!FORBIDDEN_IDENTITY_EQUALS_WARNING!>a.prop_4 === null<!> || true) {
        if (a.prop_4 != null) {
            a.prop_4
...
// TESTCASE NUMBER: 17
val case_17 = <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Int")!>if (nullableIntProperty == null || <!FORBIDDEN_IDENTITY_EQUALS_WARNING!>nullableNothingProperty === nullableIntProperty<!>) 0 else {
