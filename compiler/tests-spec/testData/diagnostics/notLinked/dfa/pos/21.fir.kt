 ...
 */
fun case_2(x: Any) {
    if (<!FORBIDDEN_IDENTITY_EQUALS_WARNING!>x is Int === true<!>) {
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any & kotlin.Int")!>x<!>
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any & kotlin.Int")!>x<!>.inv()
    }
}
 ...
 */
fun case_7(x: Any) {
    if (<!FORBIDDEN_IDENTITY_EQUALS_WARNING!>!(x is DeepObject.A.B.C.D.E.F.G.J) !== false<!>) else {
 ...
 */
fun case_8(x: Any?) {
    if (<!FORBIDDEN_IDENTITY_EQUALS_WARNING!><!FORBIDDEN_IDENTITY_EQUALS_WARNING!><!FORBIDDEN_IDENTITY_EQUALS_WARNING!>!(x is Int?) !== false<!> !== false<!> !== false<!>) else {
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & kotlin.Int?")!>x<!>
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Any? & kotlin.Int?")!>x<!>?.inv()
    }
}
 ...
 */
fun case_9(x: Any?) {
    if (<!FORBIDDEN_IDENTITY_EQUALS_WARNING!><!FORBIDDEN_IDENTITY_EQUALS_WARNING!>!!(x !is TypealiasNullableStringIndirect<!REDUNDANT_NULLABLE!>?<!>) !== false<!> === true<!>) else {
 ...
 */
fun case_10(x: Any?) {
    if (<!FORBIDDEN_IDENTITY_EQUALS_WARNING!>!!(x !is Interface3) === true<!> && true) else {
