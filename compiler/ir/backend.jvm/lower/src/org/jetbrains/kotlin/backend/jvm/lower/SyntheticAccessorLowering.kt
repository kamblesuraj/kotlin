    ...
    private val IrConstructor.isOrShouldBeHiddenSinceHasMangledParams: Boolean
        get() {
            ...
            return isOrShouldBeHiddenDueToOrigin && !DescriptorVisibilities.isPrivate(visibility)
                    && !constructedClass.isValue && (context.multiFieldValueClassReplacements.originalConstructorForConstructorReplacement[this] ?: this).hasMangledParameters() && !constructedClass.isAnonymousObject
        }
