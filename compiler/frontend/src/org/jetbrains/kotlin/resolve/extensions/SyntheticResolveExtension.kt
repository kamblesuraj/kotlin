...
interface SyntheticResolveExtension {
        ...
        fun getInstance(project: Project): SyntheticResolveExtension {
            ...
            return object : SyntheticResolveExtension {
                ...
                override fun getSyntheticCompanionAnnotations(thisDescriptor: ClassDescriptor): Annotations =
                    CompositeAnnotations(instances.map { withLinkageErrorLogger(it) { getSyntheticCompanionAnnotations(thisDescriptor) } })
    ...
    /**
     * This method should return annotations for a synthetic companion object (EMPTY by default)
     * It's used for adding @JsExport.Ignore annotation call to synthetic companions generated by kotlinx.serialization plugin
     */
