...
fun generateTemporaryVariable(
    ...
    withResolvedStatus: Boolean = false
): FirProperty =
    buildProperty {
        this.source = source
        ...
        isVar = false
        isLocal = true
        status = if (withResolvedStatus) {
            FirResolvedDeclarationStatusImpl(Visibilities.Local, Modality.FINAL, EffectiveVisibility.Local)
        } else {
